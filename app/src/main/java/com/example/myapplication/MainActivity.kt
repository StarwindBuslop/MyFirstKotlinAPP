...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //viewModel = ViewModelProvider(this).get(VinDecoderViewModel::class.java)

        /* This code is need to be reviewed
              ...
              // Set click listener for the button to invoke API call
                ...
                // Implement EditText text change listener and validation
                findViewById<EditText>(R.id.vinEditText).addTextChangedListener {
                    val vin = it.toString()
                    if (vin.length == 17) {
